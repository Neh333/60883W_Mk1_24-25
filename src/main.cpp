...
#define AUTO_SWITCH(){ \
    ...
    case 1:  controller.print(2, 0, "WinP-B   %.2f   ",imu.get_heading()); break;\
		case 2:  controller.print(2, 0, "RingS-R   %.2f   ",imu.get_heading()); break;\
    case 3:  controller.print(2, 0, "RingS-B   %.2f   ",imu.get_heading()); break;\
		case 4:  controller.print(2, 0, "GoalS-R  %.2f   ",imu.get_heading()); break;\
    case 5:  controller.print(2, 0, "GoalS-B  %.2f   ",imu.get_heading()); break;\
		case 6:  controller.print(2, 0, "RingE-R  %.2f   ",imu.get_heading()); break;\
    case 7:  controller.print(2, 0, "RingE-B  %.2f   ",imu.get_heading()); break;\
...
void opcontrol() {
 ...
 while (true) {
   ...
   pros::lcd::print(3, "liftRot: %.2f", liftRot.get_position());
   /*
